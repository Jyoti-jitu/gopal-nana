...
export function StatusBadge({ status, className }: StatusBadgeProps) {
  ...
  const styles: Record<string, { bg: string; text: string; dot: string; label: string }> = {
    ...
    archived: { bg: "bg-slate-100 border-slate-200", text: "text-slate-700", dot: "bg-slate-400", label: "Archived" },
    new: { bg: "bg-blue-50 border-blue-200", text: "text-blue-700", dot: "bg-blue-500", label: "New" },
